...
$H_0$: Race and income are not predictors of complaints per capita..

$H_a$: Race and/or income are predictors of complaints per capita.
---
...
**ANOVA summary statistics for pblack**


```{r test2, eval=TRUE}
inference(y = sdata$pcomp, x = sdata$pblack, est = "mean", type = "ht", null = 0, alternative = "greater", method = "theoretical")
