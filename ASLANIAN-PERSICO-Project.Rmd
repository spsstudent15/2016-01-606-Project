...
3095931 estimated households in NYC
...
sumzipdata <- getURL("https://raw.githubusercontent.com/spsstudent15/2016-01-606-Project/master/zipdatacsv1.csv")
...
hist(sdata$pwhite, col="#ffcc80", breaks=20, main="White Population", xlab="Percent Whites in Zip Code", ylim=c(0,70))

hist(sdata$pblack, col="#26a69a", breaks=20, main="Black Population", xlab="Percent Blacks in Zip Code", ylim=c(0,70))
```


```{r scatter1, eval=TRUE}
# Scatterplots for Income
...
boxplot(
    ...
    col=(c("#E8EAF6","#c5cae9","#9fa8da","#7986cb","#5c6bc0")),
    names=(c("BRONX","BKLYN","MANHATTAN","QUEENS","STATEN IS.")), 
    main="Per Capita Complaints by Borough, Faded Markings Only", ylab="Per Capita Faded Markings Complaints", xlab="Borough")
```

> *Compare means of distributions by splitting the weight variable into the habit groups.*
