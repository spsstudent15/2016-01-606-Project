...
datatable(df1, options = list( pageLength = 5, lengthMenu = c(5, 10)), rownames= TRUE)

```

#### 311 Street Condition Complaint Categories

```{r, eval=TRUE, warning= FALSE, message=FALSE}

complaintlist<-getURL("https://raw.githubusercontent.com/spsstudent15/2016-01-606-Project/master/listcomplainttypes.csv")

df2<- data.frame(read.csv(text=complaintlist))

datatable(df, options = list( pageLength = 5, lengthMenu = c(5, 10)), rownames= TRUE)
```
